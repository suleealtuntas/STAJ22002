...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Her bir işlevin/modülün kodlaması ve hata ayıklaması tamamlandı mı?
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Uçtan uca yazılım unsurlarının simüle edilmiş ortamla uyumlu mevcut sistemler/simülasyonlar ile arayüzleri geliştirildi mi?
        ...
        <tr>
            <td>GM 1.3</td>
            <td>İşlevlerin/Modüllerin simüle edilmiş ortamda entegrasyonunun fiziki gösterimi yapıldı mı?
        ...
        <tr>
            <td>GM 1.4</td>
            <td>Yazılım mimarisi, veritabanı ve arayüzlerin yapısı tamamlandı mı?
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnNextLevel.onclick = function() {
                    window.location.href = 'yazilim6.php';  // İkinci seviyeye git
                };
