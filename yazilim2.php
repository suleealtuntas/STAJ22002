...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Hedeflenen yazılımın potansiyel uygulamaları belirlendi mi?
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Potansiyel uygulamaların yapılabilirliği (fizibiletesi) doğrulandı mı?
        ...
        <tr>
            <td>GM 1.3</td>
            <td>Algoritmaların ve yazılım konseptinin temel özellikleri tanımlandı mı?
        ...
        <tr>
            <td>GM 1.4</td>
            <td>Yazılımın üzerinde çalışacağı donanım halihazırda mevcut mu?
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnNextLevel.onclick = function() {
                    window.location.href = 'yazilim3.php';  // İkinci seviyeye git
                };
