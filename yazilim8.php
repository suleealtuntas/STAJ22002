...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Yazılım teknolojisi operasyonel donanım ve yazılım sistemleriyle tam olarak entegre edildi mi?
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Yazılım hatalarının tamamı ayıklandı mı?
        ...
        <tr>
            <td>GM 1.3</td>
            <td>Yazılım geliştirme belgeleri tamamlandı mı?
        ...
        <tr>
            <td>GM 1.4</td>
            <td>Yazılımın tüm işlevlerinin, simüle edilmiş operasyonel senaryolarda başarılı bir şekilde fiziki gösterimi yapıldı mı?
        ...
        <tr>
            <td>GM 1.5</td>
            <td>Metodoloji ve yazılım ''Gerçekleme ve Doğrulama'' (Verification and Validation) tamamlandı mı?
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnNextLevel.onclick = function() {
                    window.location.href = 'yazilim9.php';  // İkinci seviyeye git
                };
