...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Sistem arayüz gereksinimleri belirlendi mi?
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Daha sonraki geliştirme fazları için sistem seviyesi performans tahminleri yapıldı mı?
        ...
        <tr>
            <td>GM 1.3</td>
            <td>Orta sadakat seviyesindeki deney modelinin gösterimi yapıldı mı?  
        ...
        <tr>
            <td>GM 1.4</td>
            <td>Boyutlandırma metotları, limitasyonlar, hedeflenen uygulama için ilgili tasarım prensipleri doğrulandı mı? 
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnNextLevel.onclick = function() {
                    window.location.href = 'gm6.php';  // İkinci seviyeye git
                };
