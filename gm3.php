...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Kavram/uygulamanın kritik fonksiyonları/bileşenleri belirlendi mi? 
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Anahtar parametreler için ön performans metrikleri saptandı mı?
        ...
        <tr>
            <td>GM 1.3</td>
            <td>Malzeme ve sürecin ürüne ve endüstriyel ortama entegrasyonunun ön değerlendirmesi yapıldı mı?
        ...
        <tr>
            <td>GM 1.4</td>
            <td>Teknolojiyi ürününe entegre edecek Ürün Grubu’nun kabulü sağlandı mı?
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnNextLevel.onclick = function() {
                    window.location.href = 'gm4.php';  // İkinci seviyeye git
                };
