...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Yazılım teknolojisi gerçek ortamda ve gerçek senaryolarda donanım ve yazılım sistemleriyle birlikte çalışır durumda mı?
            </td>
            <td>
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Yazılım teknolojisi gerçek operasyonel ortamda halihazırda,tekrar edilebilir ve yeniden kullanılabilir şekilde mi?
            </td>
            <td>
        ...
        <tr>
            <td>GM 1.3</td>
            <td>Yazılım mühendisliği desteği mevcut ve sürülebilir durumda mıdır?
            </td>
            <td>
