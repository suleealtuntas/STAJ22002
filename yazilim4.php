...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Veri formatlarının analizi sağlanarak, her bir modülün yazılım mimari modeliyle uyumluluğu sağlandı mı?
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Yazılım, yapay tam ölçek problemleri çözümlüyor veya temsili veri setlerini tam olarak işleyebiliyor mu?
        ...
        <tr>
            <td>GM 1.3</td>
            <td>Tüm işlevlerin veya modüllerin geçici entegrasyonunun laboratuvar ortamında fiziki gösterimi yapıldı mı?
        ...
        <tr>
            <td>GM 1.4</td>
            <td>Entegre edilen işlevlerin veya modüllerin fonksiyonel olarak doğrulaması yapıldı mı?
        ...
        <tr>
            <td>GM 1.5</td>
            <td>Yazılım mimari modelinin birlikte çalışabilirlik, güvenilirlik,sürdürülebilirilik, genişletebilirlik, ölçeklendirebilirlik ve güvenlik konularını içerecek şekilde geliştirilmesine başlandı mı?
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnNextLevel.onclick = function() {
                    window.location.href = 'yazilim5.php';  // İkinci seviyeye git
                };
