...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Yazılım gereksinimleri genel hatlarıyla tamamlandı mı?
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Hedeflenen yazılım ürününün temel özellikleri, matematiksel formülasyonunu ve genel algoritmasını destekleyen/sınayan bilimsel bilgiler elde edildi mi?
        ...
        <tr>
            <td>GM 1.3</td>
            <td>Destekleyici/sınayıcı temel prensipler, bilimsel kurallar ve varsayımlar gözlemlendi ve doğrulandı mı?
        ...
        <tr>
            <td>GM 1.4</td>
            <td>Gözlem ve doğrulama/sınama araştırmaları sonucunda yazılım mimarisine ilişkin bilimsel bilgi geliştirildi mi?
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnNextLevel.onclick = function() {
                    window.location.href = 'yazilim2.php';  // İkinci seviyeye git
                };
