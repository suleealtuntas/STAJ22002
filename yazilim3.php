...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Yazılımın performans özellikleri ve geliştirilen algoritmalar, analitik çalışmalarla doğrulandı mı?
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Yazılıma ilişkin algoritmaların ana hatları dokümante edildi mi?
        ...
        <tr>
            <td>GM 1.3</td>
            <td>İlk yazılım kodlamaları, yazılımın operasyonel gereksinimi karşıladığı doğrulandı mı?
        ...
        <tr>
            <td>GM 1.4</td>
            <td>Destekleyici/sınayıcı temel prensipler, bilimsel kurallar ve varsayımlar gözlemlendi ve doğrulandı mı? ( Demonstration)
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnNextLevel.onclick = function() {
                    window.location.href = 'yazilim4.php';  // İkinci seviyeye git
                };
