...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Teknolojinin TUSAŞ mühendislik kabiliyetlerine (yeni yetkinlikler, metot, araç vb.) ve tedarik zincirine etkisinin ön değerlendirmesi yapıldı mı?</td>
            <td>
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Potansiyel uygulamalar tanımlandı mı?</td>
            <td>
        ...
        <tr>
            <td>GM 1.3</td>
            <td>Ön performans tahminleri yapıldı mı?</td>
            <td>
        ...
        <tr>
            <td>GM 1.4</td>
            <td>Ön analitik çalışmalar temel kavramı doğruladı mı?</td>
            <td>
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnSonuc.onclick = function() {
                    window.location.href = 'panel.php?status=incomplete';
                };
            }
        }
