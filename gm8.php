...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Alt sistem tasarımları tamamlandı mı?
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Tüm donanım ara yüzleri tanımlandı mı?
        ...
        <tr>
            <td>GM 1.3</td>
            <td>Sistem tasarımı tamamlandı mı?
        ...
        <tr>
            <td>GM 1.4</td>
            <td>Nihai ürüne entegre edilecek bileşen / alt sistem / sistem donanımlarının kabul testleri tamamlandı mı?
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnNextLevel.onclick = function() {
                    window.location.href = 'gm9.php';  // İkinci seviyeye git
                };
