...
<body>
    ...
    <table>
        ...
        <tr>
            <td>GM 1.1</td>
            <td>Operasyonel ortam tanımı son haline getirildi mi? Kritik noktalar belirlendi mi? 
        ...
        <tr>
            <td>GM 1.2</td>
            <td>Yüksek sadakatli tam ölçekli prototip bütün kritik ölçek gereksinimlerini sağlayacak şekilde imal edildi mi?
        ...
        <tr>
            <td>GM 1.3</td>
            <td>Tam ölçekli prototip ilgili ortamda çalıştırılarak kritik çevre koşullarında çalıştığının gösterimi yapıldı mı?
        ...
        function calculateTotal() {
            ...
            if (result >= 80) {
                ...
                btnNextLevel.onclick = function() {
                    window.location.href = 'gm7.php';  // İkinci seviyeye git
                };
